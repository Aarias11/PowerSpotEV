          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300/90 mt-1">The PowerEV App provides an intuitive map interface that allows users to locate nearby charging stations in real-time. The app uses OpenChargeMap and Google Maps APIs to display up-to-date information on the availability, status, and types of chargers available at each station.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300/90 mt-1">Users can save their favorite charging stations for quick access and plan their trips with integrated route suggestions. The app allows users to mark stations they prefer or frequently use, and it can suggest optimized routes that include these stations along the way.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300/90 mt-1">Join a community of EV users to share tips, provide feedback on charging stations, and support each other in the transition to electric vehicles.</p>
              </div>
            </div>
          </div>
        </div>
